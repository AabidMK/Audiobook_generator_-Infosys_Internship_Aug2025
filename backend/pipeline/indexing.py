import logging
from backend.core.enhanced_extraction import EnhancedTextExtraction  
from backend.rag.text_chunking import  chunk_multiple_documents 
from backend.rag.vector_embedding import initialize_embedding_model, embed_chunks_for_pipeline
from backend.rag.chroma_storing import get_chroma_client, get_or_create_collection, store_chunks, persist_client
